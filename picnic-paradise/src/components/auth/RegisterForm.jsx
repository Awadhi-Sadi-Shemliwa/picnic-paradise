  ...
  return (
    <div className="max-w-md w-full mx-auto p-6 bg-gradient-to-br from-slate-300 via-gray-700 to-neutral-900 dark:bg-gradient-to-br dark:from-slate-300 dark:via-gray-700 dark:to-blue-700 rounded-lg shadow-md">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-serif font-bold text-gray-900 dark:text-white">Create an Account</h2>
        <p className="text-gray-600 dark:text-gray-300 mt-2">Join us to discover premium experiences</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Button
          ...
          fullWidth
          isLoading={isLoading}
          leftIcon={!isLoading ? <UserPlus size={18} /> : undefined}
        >
          Create Account
        </Button>
      </form>
